...
# 将数据转化为字典储存格式，格式为：{年份:[[国家, gdp], [国家, gdp], ......], 年份:[[国家, gdp], [国家, gdp], ......], ......}
# 先定义一个字典对象
data_dict = {}
...
for year in sort_year_list:
    ...
    for country_gdp in year_data:
        ...
        y_data.append(country_gdp[1] / 100000000)       # 添加y轴gdp
    ...
    # 设置每一年图表的标题
    bar.set_global_opts(
        title_opts=TitleOpts(title=f"{year}年全球前8GDP情况")
    )
...
# 设置时间线自动播放
timeline.add_schema(
    play_interval=500,         # 自动播放的时间间隔，单位毫秒
